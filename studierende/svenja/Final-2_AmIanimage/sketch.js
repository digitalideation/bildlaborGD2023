...
function preload() {
    ...
    img = loadImage("assets/16orange.jpg");
    img2 = loadImage("assets/16.jpg");
    img3 = loadImage("assets/16orange.jpg");
    img4 = loadImage("assets/16.jpg");
    img5 = loadImage("assets/16.jpg");
    img6 = loadImage("assets/16.jpg");
    img7 = loadImage("assets/16.jpg");
    img8 = loadImage("assets/16.jpg");
    img9 = loadImage("assets/16orange.jpg");
    img10 = loadImage("assets/16.jpg");
    img11 = loadImage("assets/1.png");
    img12 = loadImage("assets/2.png");
    img13 = loadImage("assets/21.png");
    img14 = loadImage("assets/24.png");
    img15 = loadImage("assets/20.png");
    img16 = loadImage("assets/9.png");
    img17 = loadImage("assets/15.png");
    img18 = loadImage("assets/26.png");
    img19 = loadImage("assets/10.png");
    img20 = loadImage("assets/22.png");
    img21 = loadImage("assets/27.png");
}
...
function draw() {
    ...
    scale(groesse);
    texture(img11);
    plane(img11.width, img10.height);
    pop();

    push();
    translate(-width / 100, -height / 100, -11000);
    // rotateX(mouseX / 100);
    scale(10);
    texture(img21);
    plane(img11.width, img10.height);
