...
function setup() {
    ...
    canvas.addEventListener('mousemove', function(event) {
        ...
        // Mappe die Mausposition auf den Farbwertbereich 0-255
        let colorValue = map(mouseX, 0, canvas.width, 0, 255);

        // Setze die Farbe der Kontur basierend auf der Mausposition
