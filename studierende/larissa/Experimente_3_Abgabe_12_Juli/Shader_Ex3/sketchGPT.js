...
function preload() {
    // Load the shader
    camShader = loadShader('/Shader_Ex3/effect.vert', '/Shader_Ex3/effect.frag');

    // Load the images
    myImg1 = loadImage('/Shader_Ex3/assets/scan21.jpg');
    myImg2 = loadImage('/Shader_Ex3/assets/scan4.jpg');
}
